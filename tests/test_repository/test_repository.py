...
class TestRepository(unittest.TestCase):
    ...
    @patch("insight_cli.api.API.make_initialize_repository_request")
    def test_initialize_with_non_existing_repository(
        ...
        mock_make_validate_repository_id_request.return_value = {"repository_id_is_valid": True}
    ...
    @patch("insight_cli.api.API.make_validate_repository_id_request")
    def test_reinitialize_with_invalid_repository_id(self, mock_make_validate_repository_id_request) -> None:
        mock_make_validate_repository_id_request.return_value = {"repository_id_is_valid": False}
        repository = Repository(self._temp_dir_path)

        with self.assertRaises(InvalidRepositoryError):
            repository.reinitialize()

    @patch("insight_cli.api.API.make_reinitialize_repository_request")
    @patch("insight_cli.api.API.make_validate_repository_id_request")
    @patch("insight_cli.api.API.make_initialize_repository_request")
    ...
    @patch("insight_cli.api.API.make_query_repository_request")
    @patch("insight_cli.api.API.make_validate_repository_id_request")
    @patch("insight_cli.api.API.make_initialize_repository_request")
    ...
    @patch("insight_cli.api.API.make_validate_repository_id_request")
    @patch("insight_cli.api.API.make_initialize_repository_request")
    def test_is_valid_with_valid_repository(
            self,
            mock_initialize_repository_request,
            mock_make_validate_repository_id_request
    ) -> None:
